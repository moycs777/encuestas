                  ...
                  <div class="col-md-4">
                    <div class="panel panel-default left">
                      <div class="panel-heading">
                        <div class="pull-right">
                          <a href="#" class="btn btn-round-sm btn-link" data-template-url="assets/tpl/partials/dropdown-list-example.html"> <i class="md md-more-vert"></i> </a>
                        </div>
                  ...
                  <div class="col-md-8">
                    <div class="card">
                      <div class="card-header">
                        <div class="actions"> <a href="#" class="btn btn-link btn-icon" data-template-url="assets/tpl/partials/dropdown-list-example.html"><i class="md md-more-vert"></i></a> </div>
            ...
            <div class="col-lg-3 col-md-12">
              <div class="p-20">
                <div class="pull-right">
                  <ul class="list-unstyled">
                    <li class="dropdown">
                      <button type="button" class="btn btn-round-sm btn-link" aria-haspopup="true" aria-expanded="false" data-template-url="assets/tpl/partials/dropdown-list-example.html" data-toggle="tooltip" title="More stats"> <i class="md md-equalizer"></i> </button>
                    </li>
                  </ul>
                </div>
